...
public class MJH_ListviewAdapter extends BaseAdapter {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        TextView techTextView = (TextView) convertView.findViewById(R.id.textView2) ;
        ...
        // 아이템 내 각 위젯에 데이터 반영
        titleTextView.setText(listViewItem.getStep());
    ...
    public void addItem(String title, String tech, String desc) {
