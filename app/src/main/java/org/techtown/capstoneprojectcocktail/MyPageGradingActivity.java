...
public class MyPageGradingActivity extends AppCompatActivity {
    ...
    private ArrayList Grading_score;        //사용자 uid
    ...
    protected void onResume() {
        ...
        Grading_score = new ArrayList();
        method = new String[200];
        Recipe_Base = new String[200];
        abv = new String[200];
        Score = new String[200];
        count = 0;
                    ...
                    public void onComplete(@NonNull Task<QuerySnapshot> task) {
                        if (task.isSuccessful()) {
                            for (QueryDocumentSnapshot document : task.getResult()) {
                                ...
                                Grading_score.add(document.get("점수").toString());
                                            ...
                                            if (task.isSuccessful()) {
                                                ...
                                                if (document.exists()) {
                                                    ...
                                                    adapterForCocktailGrading.addItem(new Cocktail(Grading_name.get(count).toString(), Integer.parseInt((String) Grading_id.get(count)),
                                                            method[count], Recipe_Base[count], abv[count],Grading_ref.get(count).toString(),Grading_score.get(count).toString()));
                                                    count++;
